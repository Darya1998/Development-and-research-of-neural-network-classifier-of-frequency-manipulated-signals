...
from find_snr import find_snr_simply
...
str1_noise = fs.join('/home/dashat/new_programm/noise.hdf5')
str1_quantile = fs.join('/home/dashat/new_programm/quantile.hdf5')
